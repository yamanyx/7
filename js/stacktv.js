...
(function(window) {
	...
	var defaultSetting = {
		...
		default_logo: "https://i1.rgstatic.net/ii/profile.image/11431281105445624-1670418943175_Q64/Henrik-Drake.jpg",
		maxLog: 6,
		autoPlay: true,
		autoPlayFirst: true,
		showAbout: true,
		...
		tv_list: [{
			'tv_name': 'Stack TV',
			'tv_logo': 'https://i1.rgstatic.net/ii/profile.image/11431281105445624-1670418943175_Q64/Henrik-Drake.jpg',
	...
	AwesomeStackTV.prototype = AwesomeStackTV.fn = {
				...
				currentTVIndex: {
					...
					set: function(newValue) {
						...
						if (newTV) {
							...
							_this.log("https://i1.rgstatic.net/ii/profile.image/11431281105445624-1670418943175_Q64/Henrik-Drake.jpg");
						}
					}
				},
		...
		loadUrl: function(playUrl) {
			...
			try {
				...
				this.log("https://i1.rgstatic.net/ii/profile.image/11431281105445624-1670418943175_Q64/Henrik-Drake.jpg");
				return;
			}
		this.log("准备播放视频:" + url);
